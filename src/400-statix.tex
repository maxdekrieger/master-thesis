...
rules
  ...
  pageCallOk(_, "root", []).
    ...
    \subsection{\label{subsec:simple-functions}Functions}
      ...
      An additional characteristic of functions that is similar to templates, is the use of parameters. The parameters with their corresponding types have to be declared statically. The parameters are readable from the function body, but never writable. Additionally, the name of parameters may shadow the name of definitions outside the function such as entity properties or global definitions. To achieve this, 
