...
\chapter{\label{chap:introduction}Introduction}
  ...
  \section{\label{sec:why-webdsl}Why WebDSL as a case study?}
  ...
  \section{\label{sec:contributions}Contributions}
    ...
    \begin{itemize}
      ...
      \item We assess the run time performance of Statix and SDF3 by benchmarking the new WebDSL front-end using test suites and large codebases of existing applications.
    \end{itemize}
